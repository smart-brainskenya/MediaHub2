                ...
                <div class="p-6 text-gray-900">
                    <form action="{{ route('admin.categories.store') }}" method="POST">
                        ...
                        <div class="mt-4">
                            ...
                            <input id="color" name="color" type="color" class="block mt-1 h-10 w-20 rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" value="{{ old('color', '#38B6FF') }}" />
                            @error('color')
                                <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                         ...
                         <div class="mt-4">
                            ...
                            <input id="icon" name="icon" type="text" class="block mt-1 w-full rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" value="{{ old('icon') }}" placeholder="e.g. photo-frame" />
                            @error('icon')
                                <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
